...
-->
</style><title>Bienvenido <?php echo $dato ['nombre']?></title><table width="958" border="0" align="center" cellpadding="0" cellspacing="0" class="home">
  <!--DWLayoutTable-->
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="19"></td>
          <td colspan="3" valign="top" class="Tarjeta2"><span class="Estilo6"><?php echo $dato['ocup_s'] ?></span></td>
              <td></td>
        </tr>
      <tr>
        <td height="8"></td>
  ...
  <tr>
    <td height="90" colspan="7" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="15"></td>
        <td valign="top" class="Estilo10">&copy; 2012 Roomba, M.R.</td>
          <td></td>
        <td></td>
      </tr>
      <tr>
