...
--
-- Servidor: localhost
-- Tiempo de generación: 30-09-2015 a las 04:58:33
...
INSERT INTO `objeto` (`id`, `id_cuarto`, `id_tipo_objeto`, `ruta`, `z-index`, `alto`, `ancho`, `left`, `top`) VALUES
(1, 1, 1, 'objetos/cama-1.png', 0, 10, 10, 33, 196),
(6, 1, 2, 'objetos/armario.png', 0, 50, 60, 379, 140),
(9, 1, 2, 'objetos/armario.png', 0, 55, 22, -254, 127),
(10, 2, 2, 'objetos/armario.png', 0, 50, 50, 50, 50);
